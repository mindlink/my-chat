 ...
 */
public class PhoneAndCreditCardTest {
    /**
     * Tests that credit and phone numbers are redacted in the exported messages.
     * Expected output: That credit card and phone numbers will be redacted in the export
     * Actual output: Credit card and phone numbers were redacted in the export
	 * @throws Exception When something bad happens.
     */
    @Test
    public void PhoneAndCreditCardTestTest() throws Exception {
        ConversationExporter exporter = new ConversationExporter();
        exporter.exportConversation("PhoneAndCreditCardTest.txt", "PhoneAndCreditCardTest.json");
        ...
        Conversation c = g.fromJson(new InputStreamReader(new FileInputStream("PhoneAndCreditCardTest.json")), Conversation.class);
