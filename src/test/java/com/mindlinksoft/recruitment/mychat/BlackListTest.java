...
public class BlackListTest {
    /**
     * Tests that the black list redacts words put on it.
     * Expected output: For the blacklist to replace a blacklisted word with **redacted*
     * Actual output The blacklist replaced the blacklisted words as expected
	 * @throws Exception When something bad happens.
     */
	
	
    @Test
    public void testBlackListTest() throws Exception {
