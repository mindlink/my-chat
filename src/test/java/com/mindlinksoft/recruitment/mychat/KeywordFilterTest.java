...
public class KeywordFilterTest {
    /**
     * Tests that messages can be filtered by keywords
     * Expected output: For the keyword filter to ensure that only filtered messages are exported
     * Actual output: Messages were exported according to the keyword provided
	 * @throws Exception When something bad happens.
     */
	
	
    @Test
    public void testKeywordFilterTest() throws Exception {
