...
public class ConversationExporterTests {
    ...
    public void testExportingConversationExportsConversation() throws Exception {
        ...
        exporter.exportConversation(config, new Reader(), new Writer());
        ...
        assertEquals(ms[5].getUsername(), "bob");
        ...
        assertEquals(ms[6].getUsername(), "angus");
