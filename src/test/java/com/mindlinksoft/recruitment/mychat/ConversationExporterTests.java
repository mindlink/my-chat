...
public class ConversationExporterTests
{
     ...
     */
    @Test
    public void testExport_basic() throws Exception
    {
    ...
    @Test
    public void testExport_user_bob() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
    ...
    @Test
    public void testExport_user_mike() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("mike");
    ...
    @Test
    public void testExport_user_angus() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_keyword_there() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_keyword_pie() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_keyword_yes() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_keyword_hell() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_user_bob_keyword_pie() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
    ...
    @Test
    public void testExport_user_mike_keyword_you() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("mike");
    ...
    @Test
    public void testExport_user_angus_keyword_hell() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("angus");
    ...
    @Test
    public void testExport_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_wordsToHide_empty() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_user_bob_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
    ...
    @Test
    public void testExport_user_mike_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("mike");
    ...
    @Test
    public void testExport_user_angus_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("angus");
    ...
    @Test
    public void testExport_keyword_there_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setKeyword("there");
    ...
    @Test
    public void testExport_keyword_pie_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setKeyword("pie");
    ...
    @Test
    public void testExport_keyword_yes_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setKeyword("yes");
    ...
    @Test
    public void testExport_keyword_hell_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setKeyword("hell");
    ...
    @Test
    public void testExport_keyword_the_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
    ...
    @Test
    public void testExport_keyword_you_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setKeyword("you");
    ...
    @Test
    public void testExport_user_bob_keyword_pie_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
    ...
    @Test
    public void testExport_user_mike_keyword_you_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("mike");
    ...
    @Test
    public void testExport_user_angus_keyword_hell_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("angus");
    ...
    @Test
    public void testExport_user_mike_keyword_hell_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("mike");
    ...
    @Test
    public void testExport_user_bob_keyword_im_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
    ...
    @Test
    public void testExport_user_bob_keyword_thanks_wordsToHide() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
    ...
    @Test
    public void testExport_hideCCPN() throws Exception
    {
    ...
    @Test
    public void testExport_user_tom_hideCCPN() throws Exception
    {
        config.setInputFilePath("chatDetails.txt");
        config.setOutputFilePath("chatDetails.json");
        config.setUser("tom");
    ...
    @Test
    public void testExport_keyword_credit_hideCCPN() throws Exception
    {
        config.setInputFilePath("chatDetails.txt");
        config.setOutputFilePath("chatDetails.json");
    ...
    @Test
    public void testExport_obfuscate() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setObf(true);
    ...
    @Test
    public void testExport_user_bob_obfuscate() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
    ...
    @Test
    public void testExport_keyword_hell_obfuscate() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setKeyword("hell");
    ...
    @Test
    public void testExport_report() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        ...
        assertEquals(3, c.getUserReport().size());

        User[] ur = new User[c.getUserReport().size()];
        c.getUserReport().toArray(ur);

        assertEquals(ur[0].getSenderId(), "bob");
        assertEquals(ur[0].getMessageCount(), 3);

        assertEquals(ur[1].getSenderId(), "angus");
        assertEquals(ur[1].getMessageCount(), 2);

        assertEquals(ur[2].getSenderId(), "mike");
        assertEquals(ur[2].getMessageCount(), 2);
    }

    @Test
    public void testExport_user_bob_report() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setUser("bob");
        ...
        assertEquals(1, c.getUserReport().size());
    ...
    @Test
    public void testExport_keyword_there_report() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setKeyword("there");
        ...
        assertEquals(2, c.getUserReport().size());

        User[] ur = new User[c.getUserReport().size()];
        c.getUserReport().toArray(ur);

        assertEquals(ur[0].getSenderId(), "bob");
        assertEquals(ur[0].getMessageCount(), 2);

        assertEquals(ur[1].getSenderId(), "angus");
        assertEquals(ur[1].getMessageCount(), 1);
    }

    @Test
    public void testExport_hideCCPN_obfuscate() throws Exception
    {
        config.setInputFilePath("chatDetails.txt");
        config.setOutputFilePath("chatDetails.json");
        config.setHideCCPN(true);
    ...
    @Test
    public void testExport_obfuscate_report() throws Exception
    {
        config.setInputFilePath("chat.txt");
        config.setOutputFilePath("chat.json");
        config.setObf(true);
        ...
        assertTrue(ur[0].getSenderId().matches("^\\d{6}$"));
        assertEquals(ur[0].getMessageCount(), 3);

        assertTrue(ur[1].getSenderId().matches("^\\d{6}$"));
        assertEquals(ur[1].getMessageCount(), 2);
    ...
    @Test
    public void testExport_hideCCPN_report() throws Exception
    {
        config.setInputFilePath("chatDetails.txt");
        config.setOutputFilePath("chatDetails.json");
        config.setHideCCPN(true);
        ...
        assertEquals(ur[0].getSenderId(), "tom");
        assertEquals(ur[0].getMessageCount(), 3);

        assertEquals(ur[1].getSenderId(), "ellis");
        assertEquals(ur[1].getMessageCount(), 3);
    }

    @Test
    public void testExport_hideCCPN_obfuscate_report() throws Exception
    {
        config.setInputFilePath("chatDetails.txt");
        config.setOutputFilePath("chatDetails.json");
        config.setHideCCPN(true);
